...
const HomePage = () => {
    ...
    {(() => {
        // Remove the trailing period if it exists, then split into words
        const cleanHeadline = category.headline.endsWith('.') ? category.headline.slice(0, -1) : category.headline;
        ...
        return (
            <>
                {mainText}{' '}
                <span className="font-medium italic text-transparent bg-clip-text bg-gradient-to-r from-white via-[#94A3B8] to-[#2563EB]">
                    {lastWord}.
                </span>
            </>
        );
